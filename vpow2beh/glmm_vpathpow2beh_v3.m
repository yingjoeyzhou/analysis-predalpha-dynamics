...
% 
% In the GLMM, vpath was modeled as a continuous variable. 
%
% JY (Jan 2024)
...
function [dp_beta, c_beta, statout] = get_betas_and_stats(m)
    ...
    idx_P2d = ismember( m.CoefficientNames, {'S_1:P', 'S_1:P:V'}); 
    H(1,idx_P2d) = 1;
    ...
    idx_P2c = ismember( m.CoefficientNames, {'P', 'P:V'});
    H(4,idx_P2c) = -1;
    idx_P2c = ismember( m.CoefficientNames, {'S_1:P', 'S_1:P:V'});
    H(4,idx_P2c) = -1/2;
